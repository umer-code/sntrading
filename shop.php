...
<div class="container">
  <h2  style="text-align: center; color: green">Add Shops</h2>
<table style="border: 1px; height:10px; margin-left: 200px; " ><tbody><tr>
  <td>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
<tr><td>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td></tr>
<tr><td>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td></tr>
</tr></tbody></table>
  <form class="form-horizontal" action="addshop.php" method="POST">
...
<td>       <br><label >Area : </label>
           <input  name="area" style=" width: :2px;" type="text"/>
           </td>
           <td>&nbsp;&nbsp;&nbsp;</td>
           <td>
              <br><label >shopkeeper name : </label>
