...
<div class="container">
  <h2  style="text-align: center; color: green">Edit Stock</h2>
<table style="border: 1px; height:10px;" ><tbody><tr>
  <td>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
<tr><td>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td></tr>
<tr><td>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td></tr>
</tr></tbody></table>
  <form class="form-horizontal" action="edition.php" method="POST">
  ...
  <td>
    ...
    <select id="myselect" name ="product" value="<?php echo $name; ?>" >
    			<option></option>
...
<td>       <label >CRTN # &nbsp;</label>
		...
		<input type="hidden" name="id" value="<?php echo $id; ?>">
           <input  style=" width: :2px;" type="text" id="qu" value="<?php echo $quantity; ?>" name="CRTN" onblur="myFunction()"/>
</td>
<td>&nbsp;&nbsp;&nbsp;</td>
<td>       <label >Price # &nbsp;</label>
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" id="name" placeholder="Enter Invoice Number" name="invoice_name" >
      </div>
      </div>
    <div class="form-group">
